...
- 個別のポケモン・フォーム・技・特性・持ち物の対応状況や仕様、対応件数、未対応一覧、計算の詳細・例外はガイドに記載せず、`README.md` にまとめる。内部構造、データ形式、開発・運用・検証手順も `README.md` に記載する
...
- 公開仕様、対応機能、制限は `README.md` へ反映し、ガイドは「公開ガイド」の方針に従って操作に必要な説明だけを更新する
